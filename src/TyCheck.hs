...
--   ty' <- coherent ke ty
--   tychkRes <- typeCheck te ke t
--   case tychkRes of
--     Forall x ty'' -> return $ substitute x ty' ty''
--     z -> Left $ "unexpected type: expected Forall but got " ++ show z
